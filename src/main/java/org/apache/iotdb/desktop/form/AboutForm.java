...
public class AboutForm extends JDialog {
    ...
    public static void open() {
        AboutForm aboutForm = new AboutForm(IotdbDesktopApp.frame);
        aboutForm.setMinimumSize(new Dimension(400, 380));
        aboutForm.setResizable(false);
        aboutForm.setLocationRelativeTo(IotdbDesktopApp.frame);
        aboutForm.setVisible(true);
    }

    private AboutForm(Frame owner) {
        super(owner);
        ...
        try {
            String version = Utils.JSON.toObject(ResourceUtil.readUtf8Str("version.json")).get("version").asText();
        ...
        openSourceEditor.setText(""
            + "<html>"
            + "<a href=\"https://github.com/apache/iotdb\">Apache IoTDB</a><br>"
